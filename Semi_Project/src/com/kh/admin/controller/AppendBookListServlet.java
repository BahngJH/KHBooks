...
/**
 * Servlet implementation class AppendBookListServlet
 */
@WebServlet("/book/appendlist")
public class AppendBookListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AppendBookListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (logined != null) {
			if(logined.getIsAdmin() == 1){
				...
				request.getRequestDispatcher("/views/admin/bookAppendlist.jsp").forward(request, response);
